...
(function() {
  ...
  videojs.Youtube.prototype.playbackRate = function() {
      //var tRate = this.ytplayer.getPlaybackRate();
      //var xRate = this.ytplayer.getAvailablePlaybackRates();
//console.log(tRate);
