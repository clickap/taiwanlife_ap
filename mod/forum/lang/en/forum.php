...
/*elaine*/
$string['faquestion'] = 'FAQ Question';
$string['generalforum1'] = 'Site Function Forum';
$string['generalforum2'] = 'Course Content Forum';
$string['generalforum3'] = 'Quiz And Assignment Forum';
$string['generalforum4'] = 'General Content Forum';

//elaine faq
$string['qandaforums'] = 'QANDA Forum';
$string['qandaforum1'] = 'Site Function Forum';
$string['qandaforum2'] = 'Course Content Forum';
$string['qandaforum3'] = 'Else Content Forum';
$string['qandaforum4'] = 'Coopwork Content Forum';

$string['home_publish'] = 'publish to home';
$string['course_publish'] = 'publish to course';

$string['thumbup'] = 'Thumb up({$a})';
$string['alreadythumbup'] = 'Already Thumb up({$a})';
$string['cancelthumbup'] = 'Cancel Thumb up({$a})';
