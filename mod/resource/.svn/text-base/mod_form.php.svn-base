...
class mod_resource_mod_form extends moodleform_mod {
    function definition() {
        ...
        //mary org:$filemanager_options['accepted_types'] = '*';
        $filemanager_options['accepted_types'] = preg_split('/\s*,\s*/', trim('.pdf'), -1, PREG_SPLIT_NO_EMPTY);
        $filemanager_options['maxbytes'] = 0;
        //mary org:$filemanager_options['maxfiles'] = -1;
