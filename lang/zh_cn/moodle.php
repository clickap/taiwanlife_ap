...
$string['edhelpenablespelling'] = '激活或关闭拼写检查。当激活时，服务器上必须已经安装了<strong>aspell</strong>。第二个参数是<strong>默认字典</strong>。它将会在aspell没有用户所用语言的字典时使用。';
$string['edhelpfontfamily'] = '字体属性是一系列具体的或通用字体名称的列表。字体名称必须以半角逗号分隔。';
$string['edhelpfontlist'] = '定义在编辑器的下拉菜单中使用的字体。';
$string['edhelpfontsize'] = '默认的字号设定了字体的大小。<br />合法的值如下: medium、large、smaller、lager、10pt、11px。';
$string['edit'] = '编辑';
$string['edita'] = '编辑{$a}';
...
$string['editordefaultfont'] = '默认字体';
$string['editorenablespelling'] = '激活拼写检查';
$string['editorfontlist'] = '字体列表';
$string['editorfontsize'] = '默认字号';
$string['editorresettodefaults'] = '重设为默认设置';
...
$string['emailconfirmation'] = '{$a->firstname}同学，您好：

欢迎您加入ewant育网开放教育平台，在这里您将与全世界的优秀学生，一起为了求知、更上层楼而努力；您将在此遇见不同学问、不同领域中出类拔萃的教授和学术权威，并有机会成为他们的学生，学习到他们扎实深厚的知识(know what)，以及经验累积的心得(know how)。丰富的课程内容，正在等着您去挖宝呢！
 
在您按下此连结后，

  {$a->link}

您便可以迈开脚步，开始同步和成千上万的人共同学习了，透过网路学习顶尖大学开设的课程，不论白天、晚上、还是凌晨。任何时间，学习历程永不打烊。
 
我们非常欢迎您的加入！

祝您日日精进、学有所成、终身学习、永不停止！
 
ewant育网开放教育平台';

$string['emailconfirmation_tl'] = '{$a->firstname}同学，您好：

欢迎您加入Taiwan Life台湾全民学习平台，在这里您将与全世界的优秀学生，一起为了求知、更上层楼而努力；您将在此遇见不同学问、不同领域中出类拔萃的教授和学术权威，并有机会成为他们的学生，学习到他们扎实深厚的知识(know what)，以及经验累积的心得(know how)。丰富的课程内容，正在等着您去挖宝呢！
 
在您按下此连结后，

  {$a->link}

您便可以迈开脚步，开始同步和成千上万的人共同学习了，透过网络学习顶尖大学开设的课程，不论白天、晚上、还是凌晨。任何时间，学习历程永不打烊。
...
Taiwan Life台湾全民学习平台';
$string['emailconfirmation_mnet'] = '{$a->firstname}同学，您好：
...
$string['emailconfirmationsubject'] = '注册成功！{$a}欢迎您的加入';
...
$string['makethismyhome'] = '将此页设为我的默认主页';
...
<p>一个叫做“新闻”的特殊讨论区会出现在“星期”和“主题”式的课程中。这是一个很适合用来向所有学生发布通知的地方。（默认情况，所有学生都订阅此论坛，并会通过email收到您的通知。）</p>
...
$string['notice'] = '注意';
$string['noticenewerbackup'] = '这个备份文件是使用Moodle {$a->backuprelease}({$a->backupversion})创建的，它比您正在使用的Moodle {$a->serverrelease}({$a->serverversion})新。由于备份文件的下一步兼容无法保证，这可能会导致恢复的内容和备份时不一致。';
...
<p>默认情况，您的信息是被保密的，永远不会被出售或转让给它人。收集信息的目的仅仅是出于客户服务的目的，同时也用来建一个Moodle社区的统计图。</p>
...
$string['returningtosite'] = '不开放一般用户由此直接登入，烦请由原入口重返';
...
$string['sections'] = '小节';
$string['sectionusedefaultname'] = '使用默认的小节名';
...
<p>默认情况，课程中的所有有成绩的活动的结果都可以在“成绩”页看到。该页可从课程主页访问。</p>
...
//elaine category files
$string['categoryfiles'] = '类别图像';


//elaine 1021018 add school manage
$string['addnewschool'] = '新增学校';
$string['catepicture'] = '类别相片';


$string['courseinfomation'] = '课程信息';
$string['unitlist'] = '课程单元';
$string['memberlist'] = '成员列表';
$string['newsmanage'] = '公告管理';
$string['contentmanage'] = '内容管理';
$string['coursemap'] = '课程地图';
$string['coursemedia'] = '影　　音';
$string['courseresource'] = '教　　材';
$string['courseassignment'] = '作业测验';
$string['coursequiz'] = '测　　验';  


$string['coursesurvey'] = '教学评量';

$string['sendemail'] = '通 知 信';
$string['courseopensetting'] = '课程设定';
$string['scoremanage'] = '评量管理';
$string['scoremanage'] = '成绩配分';
$string['scorerangereport'] = '成绩管理';
$string['forumbonus'] = '讨论区成绩';


$string['mycoursegrade'] = '修课成绩';

$string['mymanagecourses'] = '我担任规划师课程';



//from student
$string['courseindex'] = '课程首页'; 
$string['coursescore'] = '成　　绩'; 

$string['sectionnumber'] ='第{$a}周';
$string['editallsection'] ='编辑所有单元';
$string['extresources'] ='延伸资源';
//elaine
$string['coursenews'] = '课程公告';
$string['intronews'] = '一般消息与公告';
...
//课程结束后开放数据项设定                 
$string['undownload'] = '不可下载';                   
$string['unreplies'] = '不可回复';  
$string['checkopenresourcesetting'] = '请勾选课程结束后仍要开放的功能';
$string['openresourcesetting'] = '课程结束后开放功能';

$string['categoryfiles'] = "类别图像"; 

//else语言包翻译

$string['badgecourses'] = '微学程课程'; 
//login
$string['fullname'] = '姓名'; 
$string['nickname'] = '昵称';

//讨论区成绩
$string['forumgradeset_post']='张贴与回复文章次数';
$string['forumgradeset_post10']='回复 10-20 篇加分';
$string['forumgradeset_post20']='回复 20-30 篇加分';
$string['forumgradeset_post30']='回复 30-40 篇加分';
$string['forumgradeset_post40']='回复 40-50 篇加分';
$string['forumgradeset_post50']='回复 50篇以上加分';
$string['forumgradeset_reply']='被他人回复';
$string['forumgradeset_reply10']='被回复 10-20 篇加分';
$string['forumgradeset_reply20']='被回复 20-30 篇加分';
$string['forumgradeset_reply30']='被回复 30-40 篇加分';
$string['forumgradeset_reply40']='被回复 40-50 篇加分';
$string['forumgradeset_reply50']='被回复 50篇以上加分';
$string['forumgradeset_like']='被按赞次数';
$string['forumgradeset_like10']='被按 10-20 个赞加分';
$string['forumgradeset_like20']='被按 20-30 个赞加分';
$string['forumgradeset_like30']='被按 30-40 个赞加分';
$string['forumgradeset_like40']='被按 40-50 个赞加分';
$string['forumgradeset_like50']='被按 50个赞以上加分';
$string['forumgradeset_tlike']='老师按赞加分';
$string['forumgradeset_like1']='每按一次赞加分';
$string['forumgradeset_memo']='*全部加分超过若超过0分. 则以0分计算
*讨论区加分总额请至成绩配置页面进行调整';

//editinfo.php
$string['missingsummary'] = '缺少了课程简介';
$string['missingteacher2'] = '缺少授课教师';
$string['missinggrade'] = '缺少了评分标准';
$string['missingpassgrade'] = '缺少了通过标准';
$string['missingability'] = '缺少了先修科目或先备能力';




$string['updateandnextsetp'] = '更新并至下一步';


$string['reordersections'] = '周次顺序';
$string['areyousureremoveselected'] = '您确定要删除这些周次?';
$string['coursegradepass'] = '课程及格标准:{$a}分';

$string['deletesecionerror'] = '删除错误:课程周次不可全部删除!!';



$string['home_publish'] = '公布至首页';
$string['course_publish'] = '公布至课程';
$string['gradepublishdate'] = '总成绩公布及认证下载日期设定';

$string['gradepublishdate2'] = '总成绩公布日期:{$a}';
$string['sort_startdate'] = '课程开始日期';
$string['pictureofusercert'] = '修课认证证书之个人相片及教师签名文件';
$string['usersignfile'] = '认证教师签名文件';
$string['usercertfile'] = '认证个人相片档';

$string['categorymanage'] = '类别管理';
//mary
$string['frontpagelastestcourselist'] = '显示最新开课列表';
$string['viewprofilenopermission'] = '您无权限执行此页功能，请回<a href="{$a}">上一页</a>！';