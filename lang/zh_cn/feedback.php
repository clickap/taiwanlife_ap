...
$string['cannotmapfeedback'] = '数据库问题，无法映射问卷到课程';
...
$string['chosen_feedback_response'] = '选择问卷答复';
$string['completed'] = '已完成';
$string['completed_feedbacks'] = '已提交的答复';
$string['complete_the_form'] = '回答问题...';
$string['completionsubmit'] = '提交问卷后显示为已完成';
$string['configallowfullanonymous'] = '如果设为“是”，那么不需要登录就可以参与问卷活动。这个选项只影响首页的问卷。';
...
$string['email_notification_help'] = '如果激活，有问卷被提交后，管理员会收到email通知';
$string['emailteachermail'] = '{$a->username}已经填写问卷：“{$a->feedback}”

您可以到这里查看结果：

{$a->url}';
$string['emailteachermailhtml'] = '{$a->username}已经填写问卷：<i>“{$a->feedback}”</i><br /><br />
您可以到<a href="{$a->url}">这里</a>查看结果。';
$string['entries_saved'] = '您的回答已被保存。谢谢。';
$string['export_questions'] = '导出问题';
$string['export_to_excel'] = '导出到Excel';
$string['feedback:addinstance'] = '添加新问卷';
$string['feedbackclose'] = '关闭此问卷时间';
$string['feedback:complete'] = '填写问卷';
...
$string['feedback_is_not_for_anonymous'] = '此问卷不能匿名参加';
$string['feedback_is_not_open'] = '此问卷未开放';
$string['feedback:mapcourse'] = '向全局问卷映射课程';
$string['feedbackopen'] = '开放此问卷时间';
$string['feedback:receivemail'] = '接收email通知';
$string['feedback:view'] = '查看问卷活动';
$string['feedback:viewanalysepage'] = '提交后查看分析页面';
$string['feedback:viewreports'] = '查看报告';
$string['file'] = '文件';
$string['filter_by_course'] = '按课程过滤';
$string['handling_error'] = '问卷模块动作处理出错';
...
为了保证问卷的匿名性，至少需要两个以上的回答。';
$string['item_label'] = '标签';
$string['item_name'] = '问题';
$string['label'] = '标签';
$string['line_values'] = '评分';
$string['mapcourse'] = '映射问卷到课程';
$string['mapcourse_help'] = '默认情况下，在您的主页创建的问卷表全站可用，并且会在所有使用了问卷版块的课程中出现。你可以把问卷表设成粘性版块来强制它出现，或者通过将它映射到指定的课程来限制此问卷表出现的课程。';
$string['mapcourseinfo'] = '这是一个全站问卷，所有使用了问卷版块的课程都可以使用它。你也可以通过映射来限制此问卷出现在哪些课程中。搜索课程然后将它映射到此问卷即可。';
$string['mapcoursenone'] = '没有课程被映射。问卷对所有课程可用。';
$string['mapcourses'] = '将问卷映射到课程';
$string['mapcourses_help'] = '如果您在搜索中选择了相关的课程，您可以使用映射课程将它们与本问卷关联。按住Apple或Ctrl键点击课程名，可以选择多个课程。任何时候都可以取消课程和问卷的关联。';
$string['mappedcourses'] = '已映射课程';
$string['max_args_exceeded'] = '最多只能处理 6 个参数，参数太多';
$string['maximal'] = '最大';
$string['messageprovider:message'] = '问卷提醒';
$string['messageprovider:submission'] = '问卷通知';
$string['mode'] = '模式';
$string['modulename'] = '问卷';
$string['modulename_help'] = '问卷模块可以建立自定义的问卷调查';
$string['modulenameplural'] = '问卷';
...
$string['multiplesubmit_help'] = '如果对匿名调查也启用，那么用户就可以无限次提交问卷。';
$string['name'] = '名称';
...
$string['ready_feedbacks'] = '就绪问卷';
$string['relateditemsdeleted'] = '所有用户对此问题的答复也都会被删除';
$string['required'] = '必须回答';
$string['resetting_data'] = '清空问卷的答复';
$string['resetting_feedbacks'] = '正在重置问卷';
...
$string['searchcourses_help'] = '搜索您想和此问卷关联的课程名称或代码';
...
$string['url_for_continue_help'] = '提交问卷后，继续按钮的目标缺省是课程页面。您可以在这里定义另一个目标URL。';
$string['use_one_line_for_each_value'] = '<br />每个选项只占一行！';
$string['use_this_template'] = '使用此模板';
$string['using_templates'] = '选择一个模板';
$string['vertical'] = '垂直';
$string['viewcompleted'] = '已完成的问卷';
$string['viewcompleted_help'] = '您可以查看已完成的问卷表。可以通过课程或问题查询。
对问卷的答复可以导出到Excel。';
