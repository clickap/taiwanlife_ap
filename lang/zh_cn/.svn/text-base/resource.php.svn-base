...
/*jen*/
$string['modulename_help'] = '<font color="red"> 本平台上传档案格式仅限.pdf。  </font>

这档案模组可以让教师提供一档案做为课程资源。这档案会显示在这课程介面或提示学生下载它。这档案可以包含支持性档案，比如说，一个HTML页面可以镶有图片或闪光物件。

注意，有时候学生的电脑上需要有适当的软体才能开启这档案。 

档案可以用来： 
*分享上课时拨放的简报档。 
*用来包含一个迷你网站作为课程资源。 
*提供某些应用程式的草稿档（如Photoshop的.PSD），作为学生作业的底稿，让他们编辑，修改，然后再上传。';

$string['dnduploadresource'] = '建立档案资源';
$string['resource:addinstance'] = '新增一资源';
$string['resourcedetails_sizetype'] = '{$a->size} {$a->type}';
$string['showsize'] = '显示档案大小';
$string['showsize_desc'] = '在课程页中显示档案大小';
$string['showsize_help'] = '显示档案大小，如，"3.1MB"，于档案链结的旁边。

若有多个档案在资源，所有档案的总共大会显示出来。';
$string['showtype'] = '显示档案类型';
$string['showtype_desc'] = '在课程页中显示档案类型（如， 
WORD文件）';
$string['showtype_help'] = '在链结旁边，显示档案的类型，比如"WORD文件"
