...
$string['year'] = 'Year(s)';
//mary
$string['badgeinfo'] = 'badge info';
$string['summary'] = 'summary';     
$string['badgeteacher'] = 'teacher';
$string['badgelearnmap'] = 'learnmap';
$string['badgecontent'] = 'content';
$string['badgeability'] = 'ability';
$string['badgeqna'] = 'question and answer';
$string['badgememo'] = 'memo';

$string['missingsummary'] = 'missing summary';
$string['missingability'] = 'missing ability';
$string['missinglearnmap'] = 'missing learning map';