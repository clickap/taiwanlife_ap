...
$string['emailconfirmation_tl'] = 'Hi {$a->firstname},
...
If you need help, please contact the site administrator,
{$a->admin}';
$string['emailconfirmation_mnet'] = 'Hi {$a->firstname},
...
$string['returningtosite'] = 'No straight login here. Please retry from your original entrance.';
...
/*elaine*/
$string['loginorregister'] = 'login or register';
$string['addnewschool'] = 'Add new school';
$string['catepicture'] = 'Category image';
$string['courseinfomation'] = 'Course Infomation';
$string['unitlist'] = 'Unit List';
$string['memberlist'] = 'Member List';
$string['newsmanage'] = 'New Manage';
$string['contentmanage'] = 'Content Manage';
$string['coursemap'] = 'Course Map';
$string['coursemedia'] = 'Course Media';
$string['courseresource'] = 'Course Resource';
$string['courseassignment'] = 'Assignment/Quiz';
$string['coursequiz'] = 'Course Quiz';  
$string['coursesurvey'] = 'Course Survey';
$string['sendemail'] = 'Sent Mail';
$string['courseopensetting'] = 'Course Setting';
$string['scoremanage'] = 'Score Manage';
$string['scoremanage'] = 'Course Score ';
$string['scorerangereport'] = 'Score Report';
$string['forumbonus'] = 'Forum Bonus';
$string['mycoursegrade'] = 'Courses Grade';
$string['enrolledcourselist'] = 'Enrolled Course List';
//from student
$string['courseindex'] = 'Course Index'; 
$string['coursescore'] = 'Course Score'; 
$string['sectionnumber'] ='{$a} Section';
$string['editallsection'] ='Edit All Sections';
$string['extresources'] ='ExtResources';  
$string['coursenews'] = 'Course News';
$string['intronews'] = 'Intronews';
//after course close , wish open resource               
$string['undownload'] = 'Can not Download';                   
$string['unreplies'] = 'Can not Replies';   
$string['checkopenresourcesetting'] = 'Check Open Resource When Course Close';
$string['openresourcesetting'] = 'Open Resource When Course Close';
$string['categoryfiles'] = "category image";                 
$string['badgecourses'] = 'Program Courses';             
//login
$string['fullname'] = 'Fullname'; 
$string['nickname'] = 'Nickname';      
//forum grade
$string['forumgradeset_post']='forum post and reply number';
$string['forumgradeset_post10']=' forum post 10-20';
$string['forumgradeset_post20']=' forum post 20-30 ';
$string['forumgradeset_post30']=' forum post 30-40 ';
$string['forumgradeset_post40']=' forum post 40-50 ';
$string['forumgradeset_post50']=' forum post 50 up ';
$string['forumgradeset_reply']='forum by reply number';
$string['forumgradeset_reply10']='forum by reply 10-20';
$string['forumgradeset_reply20']='forum by reply 20-30';
$string['forumgradeset_reply30']='forum by reply 30-40';
$string['forumgradeset_reply40']='forum by reply 40-50';
$string['forumgradeset_reply50']='forum by reply 50 ';
$string['forumgradeset_like']='forum by like number';
$string['forumgradeset_like10']=' forum by like 10-20';
$string['forumgradeset_like20']=' forum by like 20-30';
$string['forumgradeset_like30']=' forum by like 30-40';
$string['forumgradeset_like40']=' forum by like 40-50';
$string['forumgradeset_like50']=' forum by like 50 ';
$string['forumgradeset_tlike']='forum teacher like number';
$string['forumgradeset_like1']='for each like';
$string['forumgradeset_memo']='*All points than if more than 0 points. Places 0 points calculation
*Total points score forum please adjust the configuration page ';
//editinfo.php
$string['missingsummary'] = 'Missing summary';
$string['missingteacher2'] = 'Missing Teacher';
$string['missinggrade'] = 'Missing grade';
$string['missingpassgrade'] = 'Missing pass grade';
$string['missingability'] = 'Missing ability';
$string['updateandnextsetp'] = 'Update AND Next Step';
$string['reordersections'] = 'Reorder Sections';
$string['areyousureremoveselected'] = 'are you sure remove selected?';
$string['coursegradepass'] = 'Course grade pass:{$a}';
$string['deletesecionerror'] = 'ERROR:Delete Course Secions error!!';
$string['home_publish'] = 'Home Publish';
$string['course_publish'] = 'Course Visible';
$string['gradepublishdate'] = 'grade publish date';
$string['gradepublishdate2'] = 'grade publish date:{$a}';
$string['sort_startdate'] = 'Course Start Date';
$string['pictureofusercert'] = 'picture of user cert';
$string['usersignfile'] = 'user sign file';
$string['usercertfile'] = 'user cert file';
//mary
$string['frontpagelastestcourselist'] = 'Frontpage Lastest Course List';
$string['viewprofilenopermission'] = 'Do not have permission to view user profile,please <a href="{$a}">come back</a>¡I';