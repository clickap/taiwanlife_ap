...
class login_signup_form extends moodleform {
    function definition() {
        ...
        */
        ...
        /*elaine:add nickname field*/
        $mform->addElement('text', 'nickname', get_string('nickname'), 'maxlength="100" size="12"');
        $mform->setType('nickname', PARAM_TEXT);
        ...
        */
        $mform->addElement('hidden', 'city', 'Hsinchu');
        $mform->setType('city', PARAM_TEXT);
        ...
        $mform->addRule('lang', get_string('missingcountry'), 'required', null, 'server');  
    ...
    function validation($data, $files) {
        global $CFG, $DB;
        /*mary 103-09 strlower*/
        $data['email']=strtolower($data['email']);
        $errors = parent::validation($data, $files);

        $authplugin = get_auth_plugin($CFG->registerauth);
        /*elaine:default username*/
