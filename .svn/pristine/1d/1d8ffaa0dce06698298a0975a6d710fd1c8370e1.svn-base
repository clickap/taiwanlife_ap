...
//mary:for mooc :userlist not show student list
//org:$users = $manager->get_users_for_display($manager, $table->sort, $table->sortdirection, $table->page, $table->perpage);
global $USER; 
if(has_capability('moodle/course:create',context_system::instance()))
    ...
    $users = $manager->get_users_limitrole_display($manager, $table->sort, $table->sortdirection, $table->page, $table->perpage);
//
$users = $manager->get_users_for_display($manager, $table->sort, $table->sortdirection, $table->page, $table->perpage);
foreach ($users as $userid=>&$user) {
    ...
    //mary:org:$user['enrol'] = $renderer->user_enrolments_and_actions($user['enrolments']);
...
echo $OUTPUT->header();
//mary:org:echo $OUTPUT->heading(get_string('enrolledusers', 'enrol'));
$enrol_heading_string = get_string('enrolledusers', 'enrol').'('.get_string('totalenrolledusers', 'enrol', $manager->get_total_users()).')'; 
echo $OUTPUT->heading($enrol_heading_string);
