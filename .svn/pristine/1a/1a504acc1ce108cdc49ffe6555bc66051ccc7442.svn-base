...
$string['namenews'] = '课程公告';
$string['namenews_help'] = '课程公告，是一个用来发布消息的特别讨论区，在课程建立时会被自动创建。每门课程只能有一个新闻讨论区。只有教师和管理员可以在新闻讨论区发帖。“最近新闻”版块会显示新闻讨论区最近的讨论。';
...
//elaine 
$string['generalforum1'] = '平台功能回报区';
$string['generalforum2'] = '课程内容讨论区';
$string['generalforum3'] = '作业测试内容讨论区';
$string['generalforum4'] = '一般内容讨论区';
//FAQ
$string['qandaforums'] = '常见问题';
$string['qandaforum1'] = '平台功能问题';
$string['qandaforum2'] = '课程问题';
$string['qandaforum3'] = '其它';
$string['qandaforum4'] = '合作招募';
